const ManagePropertiesRow = ({ property, handleStatus }) => {

    const { title, price, location, username, useremail, photo, status } = property;
            ...
            <td>
                {
                    status === 'accepted' ?
                        ...
                        :
                        <>
                            <p onClick={() => handleStatus(property)} className="bg-[#e5f0fd] px-6 py-2 rounded-full inline-flex text-[#3554d1] mr-3 cursor-pointer">
                                Accept
                            </p>
