...
const Header = () => {
    return (
        <div className="w-full h-screen bg-black text-white flex flex-col justify-center items-center bg-img">
            ...
            <div className="md:w-full lg:w-[800px] xl:w-[1000px] mt-12 lg:mt-20 md:px-10 lg:px-0">
                <div className="bg-white px-6 py-6 rounded-xl flex items-center gap-x-5">
                    ...
                    <button className="h-12 w-12 rounded-full bg-[#eb6753] flex justify-center items-center text-white text-2xl">
                        <FiSearch  />
                    </button>
                </div>
            </div>
